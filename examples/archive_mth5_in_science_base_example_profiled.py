...
def code_to_profile():    
    ...
    for station in station_list:
        ...
        if z3d_dir.is_dir():
            ...
            ### Make MTH5 File
            m = MTH5(shuffle=None, fletcher32=None, compression=None,
            ...
            for run_num in [1]:
                ...
                channels = run_group.from_runts(runts_obj, chunks=None)
...
with open(r"c:\Users\jpeacock\mth5_profile_log_no_compression.log", "w") as fid:
    fid.write("\n".join(output))
